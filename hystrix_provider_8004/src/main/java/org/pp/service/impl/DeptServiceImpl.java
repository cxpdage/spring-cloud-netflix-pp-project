...
//        int outTime = 6;
    ...
    public String dept_TimeoutHandler(Integer id) {
        return  "萍萍提醒您，系统繁忙请稍后再试！"+"线程池：" + Thread.currentThread().getName() + "  deptInfo_Timeout,id:   " + id;
    }
    /*服务降级 end*/
    ...
    public String deptCircuitBreaker(Integer id) {
        if (id < 0) {
            ...
            throw new RuntimeException("萍萍提醒您，id 不能是负数！");
        }
    ...
    public String deptCircuitBreaker_fallback(Integer id) {
        return "萍萍提醒您，id 不能是负数,请稍后重试!\t id:" + id;
    }
}